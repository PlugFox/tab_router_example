...
#	@fvm flutter pub global activate intl_utils
	...
	@flutterfire configure -y \
		...
		-i dev.plugfox.go_router_example \
		-m dev.plugfox.go_router_example \
		-a dev.plugfox.go_router_example \
		-p playplugfox \
		-e plugfox@gmail.com \
...
keytool-genkey:
	@keytool -genkey -v -keystore android/app/go_router_example.keystore -alias go_router_example -keyalg RSA -keysize 2048 -validity 10000
