...
import 'category.dart' show CategoryID;

typedef ProductID = int;

@immutable
class ProductEntity with Comparable<ProductEntity> {
  const ProductEntity({
    required this.id,
    required this.title,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || (other is ProductEntity && other.id == id);
}
